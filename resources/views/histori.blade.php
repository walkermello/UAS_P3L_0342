...
<div class="container">
                ...
                @foreach ($list as $item)
                    ...
                    <div class="card">
                        ...
                        <a class="btn btn-primary" style="padding: 5px 40px" href="edit/{{ $item->id }}">Edit</a>
                        <a class="btn btn-primary" style="padding: 5px 40px;background-color: green" href="tambahRating/{{ $item->id }}">Tambah Rating</a>
                        <a class="btn btn-danger" style="padding: 5px 40px;background-color: red" href="tambahBukti/{{ $item->id }}">Bayar</a>
                    </div>
                    </div>
                @endforeach
                </div>
