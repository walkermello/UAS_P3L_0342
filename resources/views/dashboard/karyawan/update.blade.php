            ...
            <div class="col-md-4 offset-md-4" style="margin-top: 45px;">
                  <h4>Karyawan Profile</h4><hr>
                    ...
                    <div class="form-group">
                          ...
                          <a href="/karyawan/delKaryawan/{{ $Info->id }}" class="btn btn-danger" onclick="return confirm('Anda yakin ingin menghapus akun ini?')">Delete Account</a>
                    </div>
                  </form>
            </div>
        </div>
